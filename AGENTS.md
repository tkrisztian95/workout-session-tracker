...
This project is indexed by GitNexus as **workout-session-tracker** (5689 symbols, 7487 relationships, 142 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
