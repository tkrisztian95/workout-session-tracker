...
The system SHALL allow the user to specify the date and total duration (in minutes) for the new session.

#### Scenario: Date defaults to today

- **WHEN** the new session sheet opens
...
- **WHEN** the user fills in the duration field
