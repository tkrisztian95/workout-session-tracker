...
import { getUserName, saveUserName, saveLocale } from '@/lib/storage';
            ...
            {LOCALES.map(({ code, label }) => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center justify-between px-4 py-4 transition-colors duration-150 cursor-pointer ${active ? 'bg-brand/10' : 'active:bg-elevated'}`}
                >
